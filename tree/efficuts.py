...
class EffiCuts(object):
    ...
    def build_tree(self, rules,L=None):
        ...
        if L is not None: L.append(tree)
    ...
    def train(self):
        ...
        self.trees = []
        for rule_subset in rule_subsets:
            for x in rule_subset:
                print(x.priority, end=" ")
            result_subset = self.build_tree(rule_subset,self.trees)
            print(result_subset)
